    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msrvMoney.setOnValueChangedListener(new MoneySelectRuleView.OnValueChangedListener() {
            ...
            public void onValueChanged(int newValue) {
                ...
                if(tvUnit.getText().toString().equalsIgnoreCase("inches"))
                {
//                    float value;
//                    value=newValue/12;
                    tvMoney.setText(Float.toString(newValue));
                }
                else
                {
...
//    }
    ...
    private void toggleValue() {
        ...
        if(tvUnit.getText().toString().equalsIgnoreCase("cms"))
        {
            float temp= Float.parseFloat(tvMoney.getText().toString());
            temp=(float)(temp/2.54);


            msrvMoney.setValue(120,temp,0,1,12);
        ...
        else
        {
            float temp= Float.parseFloat(tvMoney.getText().toString());
            temp= (float) (temp*2.54);
            msrvMoney.setValue(310,temp,0,1,10);
            tvUnit.setText("cms");
        }
