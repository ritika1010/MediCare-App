...
public class Blood_glucose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gvRule.setValue(60, 150, 75, 0.1f, 10);
...
//                break;
    ...
    private void toggleValue() {
        if (tvUnit.getText().equals("mmol/L")) {
            float temp= (float) ((Double.parseDouble((String) tvValue.getText())));

            temp= (float) (temp*18.0182);
            gvRule.setValue(60, 150, temp, 0.1f, 10);
            tvUnit.setText("mg/dl");
        } else {
            float temp= (float) ((Double.parseDouble((String) tvValue.getText())));

            temp= (float) (temp*0.0555);
            gvRule.setValue(0, 15,temp, 0.1f, 10);
            tvUnit.setText("mmol/L");
